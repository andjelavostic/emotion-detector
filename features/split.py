...
input_csv = "../data/processed_data/features_mel_cnn.csv"
...
train_df.to_csv(os.path.join(output_dir, "train_cnn.csv"), index=False)
val_df.to_csv(os.path.join(output_dir, "val_cnn.csv"), index=False)
test_df.to_csv(os.path.join(output_dir, "test_cnn.csv"), index=False)
